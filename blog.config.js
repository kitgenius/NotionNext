...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Genie', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.chengzj.top', // 网站地址
  ...
  GREETING_WORDS:
    ...
    'Hi，我不是程序员, Hi，我是一个打工人,Hi，我是一个干饭人,欢迎来到我的网站🎉',
